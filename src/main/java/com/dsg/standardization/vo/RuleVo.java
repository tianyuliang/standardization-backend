...
@ApiModel
public class RuleVo extends RuleDto implements Serializable {
    ...
    @ApiModelProperty(value = "所属目录名称", example = "")
    private String catalogName;

    @ApiModelProperty(value = "目录全路径名称", example = "")
    ...
    @ApiModelProperty(value = "是否删除：true-已删除，false-未删除", example = "")
