...
| 9 | POST | `/v1/std-file/downloadBatch` | 批量下载 | 未找到
| 10 | GET | `/v1/std-file/relation/de/{id}` | 查询关联数据元 | 未找到
| 11 | GET | `/v1/std-file/relation/dict/{id}` | 查询关联码表 | 未找到
| 12 | GET | `/v1/std-file/relation/rule/{id}` | 查询关联编码规则 | 未找到
| 13 | PUT | `/v1/std-file/relation/{id}` | 添加关联关系 |
| 14 | GET | `/v1/std-file/relation/{id}` | 查询关联关系 |
| 15 | GET | `/v1/std-file/queryDataExists` | 查询数据是否存在 |
| 16 | PUT | `/v1/std-file/batchState` | 批量启用/停用 | 未找到
