...
// 查询关联编码规则
func QueryRelationRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Step 3: 调用业务逻辑
		l := stdfile.NewQueryRelationRuleLogic(r.Context(), svcCtx)
		resp, err := l.QueryRelationRule(id, &req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
