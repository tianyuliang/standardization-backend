...
// 查询关联的码表
func QueryRelationDictHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Step 3: 调用业务逻辑
		l := stdfile.NewQueryRelationDictLogic(r.Context(), svcCtx)
		resp, err := l.QueryRelationDict(id, &req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
