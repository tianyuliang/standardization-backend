...
// 根据ID修改标准文件
func UpdateStdFileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		var req types.UpdateStdFileReq
		...
		l := stdfile.NewUpdateStdFileLogic(r.Context(), svcCtx)
		resp, err := l.UpdateStdFile(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
